...
var FORM_8700_MAP = {
  ...
  generatorSiteAddr:  { row: 6, col: 48 },
  generatorSiteCity:  { row: 7, col: 48 },
  // Box 6 - Transporter 1
  ...
  // Box 9a - HM
  waste1hm:           { row: 21, col: 6 },
  waste2hm:           { row: 24, col: 6 },
  waste3hm:           { row: 27, col: 6 },
  waste4hm:           { row: 30, col: 6 },
  // Box 9b - Description
  ...
  // Box 11 - Quantity
  waste1qty:          { row: 21, col: 67 },
  waste2qty:          { row: 24, col: 67 },
  waste3qty:          { row: 27, col: 67 },
  waste4qty:          { row: 30, col: 67 },
  // Box 12 - Unit
  waste1uom:          { row: 21, col: 74 },
  waste2uom:          { row: 24, col: 74 },
  waste3uom:          { row: 27, col: 74 },
  waste4uom:          { row: 30, col: 74 },
  // Box 13 - Waste Codes (6 per line: 3 on row 1, 3 on row 2)
  waste1wc1:          { row: 21, col: 78 },
  waste1wc2:          { row: 21, col: 83 },
  waste1wc3:          { row: 21, col: 88 },
  waste1wc4:          { row: 22, col: 78 },
  waste1wc5:          { row: 22, col: 83 },
  waste1wc6:          { row: 22, col: 88 },
  waste2wc1:          { row: 24, col: 78 },
  waste2wc2:          { row: 24, col: 83 },
  waste2wc3:          { row: 24, col: 88 },
  waste2wc4:          { row: 25, col: 78 },
  waste2wc5:          { row: 25, col: 83 },
  waste2wc6:          { row: 25, col: 88 },
  waste3wc1:          { row: 27, col: 78 },
  waste3wc2:          { row: 27, col: 83 },
  waste3wc3:          { row: 27, col: 88 },
  waste3wc4:          { row: 28, col: 78 },
  waste3wc5:          { row: 28, col: 83 },
  waste3wc6:          { row: 28, col: 88 },
  waste4wc1:          { row: 30, col: 78 },
  waste4wc2:          { row: 30, col: 83 },
  waste4wc3:          { row: 30, col: 88 },
  waste4wc4:          { row: 31, col: 78 },
  waste4wc5:          { row: 31, col: 83 },
  waste4wc6:          { row: 31, col: 88 },
...
var BUILD_VERSION = 'v15-2026-03-06';
